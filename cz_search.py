...
if __name__ == "__main__":
    ...
    success_words = forvo.fv_get_czech_audio(key = forvo.GLOBAL['API_KEY'], wordlist = wordlist)
    success_summary(wordlist=wordlist, success_words=success_words, origin='Forvo')
